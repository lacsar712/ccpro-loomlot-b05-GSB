...
class DashboardStats(BaseModel):
    ...
    reused_house_count: int = Field(serialization_alias="reusedHouseCount")
    hardness_restricted_active_lot_count: int = Field(
        serialization_alias="hardnessRestrictedActiveLotCount"
    )
